      ...
      <main className="container my-4" style={{ maxWidth: '800px' }}>
        ...
        {vistaActual === 'inicio' && (
          <section className="text-center">
            ...
            <h1 className="mb-3">Plataforma Educativa</h1>
            <p className="text-secondary">Bienvenido a la plataforma de gestión escolar.</p>
          ...
          <section>
            {!usuario ? (
              ...
              <div className="alert alert-danger text-center" role="alert">
                ...
                <p>Debes iniciar sesión previamente para acceder al registro de estudiantes.</p>
                <hr />
                <button 
                  onClick={() => setVistaActual('inicio')} 
              ...
              <div className="card shadow p-4 text-start">
                <h2 className="card-title mb-4 border-bottom pb-2">📋 Registro de Estudiante</h2>
